...
for day in sales_data:
    total = 0
    total += day["Hamburgare"] * prices["Hamburgare"]
    total += day["Pommes frites"] * prices["Pommes frites"]
    total += day["Läsk"] * prices["Läsk"]
    total += day["Milkshake"] * prices["Milkshake"]
    total += day["Sallader"] * prices["Sallader"]
    total += day["McNuggets"] * prices["McNuggets"]
